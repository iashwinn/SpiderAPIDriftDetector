...
__name4(composeRefs2, "composeRefs");
function useComposedRefs2(...refs) {
  return React3.useCallback(composeRefs2(...refs), refs);
}
__name4(useComposedRefs2, "useComposedRefs");
...
function createCollection2(name) {
  ...
  const CollectionProviderImpl = __name6((props) => {
    ...
    const composeRefs4 = useComposedRefs2(ref, setCollectionElement);
...
var DismissableLayer = React8.forwardRef(
  ...
  __name9(function DismissableLayer2(props, forwardedRef) {
    ...
    const composedRefs = useComposedRefs3(forwardedRef, setNode);
...
var DismissableLayerBranch = React8.forwardRef(__name9(function DismissableLayerBranch2(props, forwardedRef) {
  const context = React8.useContext(DismissableLayerContext);
...
var ToastProvider = __name15((props) => {
  const {
    __scopeToast,
    label = "Notification",
    duration = 5e3,
...
var ToastViewport = React15.forwardRef(
  __name15(function ToastViewport2(props, forwardedRef) {
    const {
      __scopeToast,
    ...
    React15.useEffect(() => {
      const handleKeyDown = __name15((event) => {
        var _a2;
    ...
    React15.useEffect(() => {
      ...
      if (hasToasts && wrapper && viewport) {
        ...
        const handleFocusOutResume = __name15((event) => {
          const isFocusMovingOutside = !wrapper.contains(event.relatedTarget);
          if (isFocusMovingOutside) handleResume();
        }, "handleFocusOutResume");
        const handlePointerLeaveResume = __name15(() => {
...
var FocusProxy = React15.forwardRef(
  // blank line to reduce diff noise
  __name15(function ToastFocusProxy(props, forwardedRef) {
...
var Toast = React15.forwardRef(
  // blank line to reduce diff noise
  __name15(function Toast2(props, forwardedRef) {
...
var ToastImpl = React15.forwardRef(
  __name15(function ToastImpl2(props, forwardedRef) {
    const {
      __scopeToast,
      type = "foreground",
...
var ToastAnnounce = __name15((props) => {
...
var ToastTitle = React15.forwardRef(
  __name15(function ToastTitle2(props, forwardedRef) {
...
var ToastDescription = React15.forwardRef(
  // blank line to reduce diff noise
  __name15(function ToastDescription2(props, forwardedRef) {
...
var ToastAction = React15.forwardRef(
  __name15(function ToastAction2(props, forwardedRef) {
...
var ToastClose = React15.forwardRef(
  __name15(function ToastClose2(props, forwardedRef) {
...
var ToastAnnounceExclude = React15.forwardRef(__name15(function ToastAnnounceExclude2(props, forwardedRef) {
...
__name15(getAnnounceTextContent, "getAnnounceTextContent");
...
__name15(handleAndDispatchCustomEvent2, "handleAndDispatchCustomEvent");
var isDeltaInDirection = __name15((delta, direction, threshold = 0) => {
...
__name15(useNextFrame, "useNextFrame");
function isHTMLElement(node) {
  return node.nodeType === node.ELEMENT_NODE;
}
__name15(isHTMLElement, "isHTMLElement");
